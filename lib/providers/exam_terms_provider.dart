import 'dart:convert';
import 'package:bni/models/exam_term_model.dart';
import 'package:bni/models/result_params_model.dart';
import 'package:bni/models/term_result_model.dart';
...
final examTermsProvider = FutureProvider.family<List<ExamTerm>, String>((
  ...
  final response = await http.get(
    Uri.parse(
      'http://203.190.12.69/ems/bni/app/web_api/std_exam_results/std_progress_report_api.php?user_name=$userName',
    ),
  );
...
final resultProvider = FutureProvider.family<TermResult?, ResultParams>((
  ...
  final uri =
      Uri.parse(
        'http://203.190.12.69/ems/bni/app/web_api/std_exam_results/std_progress_report_api.php',
      ).replace(
        queryParameters: {
          'user_name': userName,
          'exam_session': '2025',
